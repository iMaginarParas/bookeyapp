    ...
    for (var endpoint in endpoints) {
      ...
      try {
        ...
        if (e.toString().contains('SocketException')) {
          results[path]['likely_cause'] = 'Network connectivity issue or DNS resolution failure';
        } else if (e.toString().contains('HandshakeException')) {
          results[path]['likely_cause'] = 'SSL/TLS certificate validation issue';
        } else if (e.toString().contains('TimeoutException')) {
          results[path]['likely_cause'] = 'Server response timeout - server may be slow or unreachable';
        } else if (e.toString().contains('ClientException')) {
          results[path]['likely_cause'] = 'HTTP client configuration issue or CORS problem';
        }
      }
    }
  ...
  static Future<Map<String, dynamic>> testHttpConfigurations() async {
    ...
    if (!kIsWeb) {
      try {
        ...
        results['custom_http_client'] = {'success': false, 'error': e.toString()};
      }
    }
